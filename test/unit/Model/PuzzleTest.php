...
class PuzzleTest extends TestCase
{
    ...
    public function getValidDefinitions()
    {
        return [
            ...
            [
                '--__  ..0023456789123456789123456789123456789123456789123456789123456789123456789',
                '000000000023456789123456789123456789123456789123456789123456789123456789123456789'
            ],
        ];
    }
}
